...
class _mobileLayoutState extends State<mobileLayout> with TickerProviderStateMixin {
  ...
  void initState(){
    ...
    widthResizingCon = ScreenSize.width! / 1.5;
    heightResizingCon = ScreenSize.height! / 2;
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left:18.0,bottom:58.0),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                            ...
                                            child:Container(
                                              ...
                                              height: MediaQuery.of(context).size.height+1150,
